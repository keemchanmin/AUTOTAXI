...
void CAN_RxIn0Handler_Ch0(void)
{
    ...
    if (readStatus == IfxMultican_Status_newData)
    {
         ...
         Can_RxQueue_Push(0,&rxMessageTemp);
    }
}
...
void Can_Init(void)
{
    ...
    Can_EnrollObject(ECU,1u, 0x003, IfxMultican_Frame_transmit,  IfxMultican_DataLengthCode_8, FALSE, &stEcu1CanCh0.CanEcu1MsgTxObj[0]);
    Can_EnrollObject(ECU,11u, 0x300, IfxMultican_Frame_receive, IfxMultican_DataLengthCode_8, FALSE, &stEcu1CanCh0.CanEcu1MsgRxObj[0]);
